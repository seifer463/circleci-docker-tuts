...
public class EmbMakePayment extends AbstractMakePayment {
	...
	public void verifyMakePayment() {
		...
		if (isNextBtnDisp) {
			...
			// let's put the account number to be able to proceed
			inputfields.accountNumber.sendKeys(getProp("test_acct_num_01"), Keys.TAB);
			clickElementAction(buttons.next);
			...
			verifyTwoStringsAreEqual(inputfields.accountNumber.getAttribute("value"), getProp("test_acct_num_01"), true);
